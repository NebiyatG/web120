...
<html>
<head>
<title>One example of webcams</title>
...
<!-- START LEFT COL -->
<section>
 <h2 class="pageID">One example of web cams</h2>
 
 <!-- My header.php include ends here --><div class="embed-container">
 
    <iframe src='https://www.youtube.com/embed/m9VO7X_q9nw' frameborder='0' allowfullscreen></iframe>
...
<!-- START Footer -->
<footer>
  <p><small>&copy; <?=date("Y")?> by <a href="index.php" target="_blank">Nebiyat</a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
</footer>
<!-- END Footer --> 
